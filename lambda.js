...
function getMeasure(parsedResponse, callback, intentName, intentSlots) {
    var data = {
        ...
        batteryOut: parsedResponse.body.modules[0].battery_percent,
        ...
        noise: parsedResponse.body.devices[0].dashboard_data.Noise
    };
    ...
    if ("AskTemperature" === intentName) {
        if ("inside" === intentSlots.Location.value) {
            speechOutput = "It is " + data.tempIn + " degrees inside.";
        } else if ("outside" === intentSlots.Location.value) {
            speechOutput = "It is " + data.tempOut + " degrees outside.";
        } else {
            speechOutput = "It is " + data.tempIn + " degrees inside and " + data.tempOut + " outside.";
        }
    } else if ("AskHumidity" === intentName) {
        if ("inside" === intentSlots.Location.value) {
            speechOutput = "It is " + data.humIn + " percent humidity inside.";
        } else if ("outside" === intentSlots.Location.value) {
            speechOutput = "It is " + data.humOut + " percent humidity outside.";
        } else {
            speechOutput = "It is " + data.humIn + " percent humidity inside and " + data.humOut + " outside.";
        }
    } else if ("AskPressure" === intentName) {
        speechOutput = "The pressure is " + data.press + " millibars inside.";
    } else if ("AskCarbonDioxide" === intentName) {
        speechOutput = "The air quaility is about " + data.co2 + " particles per meter inside.";
    } else if ("AskSound" === intentName) {
          speechOutput = "The noise level is about " + data.noise + " decibel inside.";
    } else {
        speechOutput = "What do you want to know? Ask for the temperature, humidity, pressure, noise level, air quality.";
    }
